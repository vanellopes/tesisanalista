  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../index3.html" class="brand-link">
      <img src="../dist/img/AdminLTELogo.png"
           ...
           style="opacity: .8">
      <span class="brand-text font-weight-light">InstantVet</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="registroTurno" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Registrar turno</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="listarTurnos" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Listar Todos los Turnos</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="listarTurnosVeterinaria" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Listar Turnos Veterinaria</p>
                </a>
              </li>
              <li class="nav-item">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="registroCliente" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Registrar Cliente</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="listarcliente" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Listar Clientes</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="listarpaciente.jsp" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Listar Mascotas</p>
                </a>
              </li>
