...
public class ClienteDAO extends BaseDAO {
	...
	public Cliente DAOobtenerClientexDni(Integer numDocumento) throws DAOExcepcion { // este es por id
		String query = "select clienteId,Nombres,apellido,num_documento,email,telefono,direccion,estado from Cliente where num_documento=?";
		Connection con = null;
		PreparedStatement stmt = null;
		ResultSet rs = null;
		Cliente objCliente = null;
