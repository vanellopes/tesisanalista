...
import com.instantvet.app.dao.FacturaDAO;
...
public class AdmFactura implements IFactura {
	...
	/* (non-Javadoc)
	 * @see com.instantvet.app.negocio.IFactura#GrabarFactura(com.instantvet.app.modelo.Factura)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.instantvet.app.negocio.IFactura#ElimnarFactura(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.instantvet.app.negocio.IFactura#ListarFacturas()
	 */
	@Override
